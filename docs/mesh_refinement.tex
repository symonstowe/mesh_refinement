...
\begin{figure}
  ...
  (C15) generated in Gmsh with regions of interest that were used to compare between models. 
...
of approximately 70\%. Gmsh was able to achieve a lower sensitivity error relative to 
...
to be specified relative to Netgen. Gmsh generated meshes with more nodes for the same input
parameters, but in general the resulting mesh sizes were closer to those specified. The
...
Results are summarized in Fig.~\ref{fig:balance_sens} which indicates
